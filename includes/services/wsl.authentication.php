...
function wsl_process_login_auth()
{
	...
	// display a loading message. Should be better than a white screen
	if( isset( $_REQUEST["provider"] ) && ! isset( $_REQUEST["redirect_to_provider"] ) ){
		wsl_process_login_render_loading_page();
	}

	// if user selected a provider to login with 
	...
	try{
		...
		// overwrite endpoint_url if needed
